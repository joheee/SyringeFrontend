        ...
        <main className="flex-1 relative overflow-y-auto focus:outline-none">
          ...
          <div className="py-6">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex gap-5">
              {/* Replace with your content */}
              <SyringeCard device={prop.device} index={0} prop={prop.device.syringe1} title="Syringe 1"/>
              <SyringeCard device={prop.device} index={1} prop={prop.device.syringe2} title="Syringe 2"/>
              <SyringeCard device={prop.device} index={2} prop={prop.device.syringe3} title="Syringe 3"/>
              {/* /End replace */}
            </div>
          </div>
        </main>
